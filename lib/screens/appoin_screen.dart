...
class AppoinScreen extends StatefulWidget {
  @override
  _AppoinScreenState createState() => _AppoinScreenState();
}

class _AppoinScreenState extends State<AppoinScreen> {
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => AppointmentMScreen()),
                              );
                            },
                            child: Container(
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => AppointmentVScreen()),
                              );
                            },
                            child: Container(
                              padding: const EdgeInsets.all(8.0),
