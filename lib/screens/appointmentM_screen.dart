...
class AppointmentMScreen extends StatefulWidget {
  @override
  _AppointmentMScreenState createState() => _AppointmentMScreenState();
}

class _AppointmentMScreenState extends State<AppointmentMScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    _buildDateBox('Tue', '20'),
                    SizedBox(width: 8.0),
                    _buildDateBox('Wed', '21'),
                    SizedBox(width: 8.0),
                    _buildDateBox('Thurs', '22'),
                    SizedBox(width: 8.0),
                    _buildDateBox('Fri', '23', isSelected: true),
                    SizedBox(width: 8.0),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _buildTimeSlot('10:30 am',isSelected: true),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _buildTimeSlot('5:00 pm',isSelected: true),
